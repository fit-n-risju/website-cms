...
<div className="bio-stage">
  ...
  <div className="bio-content">
    ...
    {isEnglish ? "Over the years I have worked on harmoniously bringing these components together and developing them further. I‘m excited to share this knowledge and experience with you and support you on your way to a healthy and balanced life!" : "Über die Jahre hinweg habe ich daran gearbeitet diese Komponenten harmonisch zusammen zu führen und weiter zu entwickeln. Diese Wissen und Erfahrungen möchte ich mit euch teilen und euch auf eurem Weg in ein gesundes und ausgewogenes Leben unterstützen."}</p>
    </div>
  </div>
</div>
